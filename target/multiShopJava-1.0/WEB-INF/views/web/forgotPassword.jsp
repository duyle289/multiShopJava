							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										...
										<p class="mb-4">Chỉ cần nhập địa chỉ email của bạn dưới
											đây và chúng tôi sẽ gửi cho bạn một liên kết để đặt lại mật
											khẩu của bạn!</p>
									</div>
									<form:form class="user" method="POST" action="forgotPassword"
