				...
				<div class="col-sm-12">
					<form:form method="POST" action="editcategory" modelAttribute="loaisanpham" enctype="multipart/form-data">
						<div class="form-horizontal">
							<h1 class="h3 mb-2 text-gray-800">Thông Tin loại sản phẩm</h1>
							<hr />
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<img width=150 src ="/multiShopJava/resources/HinhAnhSP/${category.getICON()}"/>
							...
							<div class="form-group">
								<div class="col-md-offset-2 col-md-10">
										...
										<a href="category" class="btn btn-danger">Trở lại</a>
								</div>
							</div>
					</form:form>
				</div>
